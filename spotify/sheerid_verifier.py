"""Chương trình xác thực sinh viên SheerID (Spotify Student)

Phiên bản này thực hiện luồng gửi ảnh/thuộc tính sinh viên tới API SheerID
và trả về trạng thái gửi (không polling trạng thái dài hạn).
"""
import re
import random
import logging
...
class SheerIDVerifier:
    """Bộ xác thực SheerID cho Spotify Student"""
    ...
    def verify(self, first_name: str = None, last_name: str = None, email: str = None, birth_date: str = None, school_id: str = None) -> Dict:
        """Thực hiện quy trình xác thực (trả về trạng thái gửi).

        Trả về dict có các khóa: success, pending, message, verification_id, redirect_url, status
        """
        try:
...
def main():
    ...
    print("SheerID Student Verification Tool (Spotify) - Python")
